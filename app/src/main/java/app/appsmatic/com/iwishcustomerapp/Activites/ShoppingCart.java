...
import app.appsmatic.com.iwishcustomerapp.API.Models.CartData;
...
import app.appsmatic.com.iwishcustomerapp.Adabters.CartAdb;
               ...
               //check if user logged in or guest
                ...
                if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    if (Home.cartMeals.isEmpty()) {
                        ...
                        dialogBuilder
                                .withTitle(getResources().getString(R.string.emptycartdialog))
