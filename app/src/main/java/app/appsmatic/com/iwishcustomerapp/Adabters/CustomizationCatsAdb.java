...
import app.appsmatic.com.iwishcustomerapp.API.Models.CustomizationMessage;
...
public class CustomizationCatsAdb extends RecyclerView.Adapter<CustomizationCatsAdb.V> {
    ...
    public void animate(RecyclerView.ViewHolder viewHolder) {
        final Animation animAnticipateOvershoot = AnimationUtils.loadAnimation(context, R.anim.slidetop);
